...
if ( $page->have_posts() ) : $page->the_post();
    $media_btn = get_field('media_button');
    $media_btn_text = get_field('media_button_text');
    $media_btn_link = get_field('media_button_link');
?>
<div class="section-content-container medias-content-container">
    <div class="section-content medias-content">

    <div class="medias-content__intro">
    ...
    <div class="medias-content__pics">
